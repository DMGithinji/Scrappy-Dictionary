...
export const addToAlgolia = functions.firestore.document(TRANSLATIONS_PATH)
    .onCreate(snapshot => {
...
export const updateToAlgolia = functions.firestore.document(TRANSLATIONS_PATH)
    .onUpdate((change) => {
...
export const deleteFromAlgolia = functions.firestore.document(TRANSLATIONS_PATH)
    .onDelete(snapshot =>
